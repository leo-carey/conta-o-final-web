      ...
      <span class="text-5xl dark:text-slate-300">
        <ElIcon>
          <svg viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
            ...
            />
            <path
              d="M26,21H14a3,3,0,0,1,0-6H26a3,3,0,0,1,0,6Z"
              fill="#f1f3f4"
            />
            <path
              d="M28,19.5H12a1.5,1.5,0,0,1,0-3H28a1.5,1.5,0,0,1,0,3Z"
              fill="#aaadbf"
            />
            <path
              d="M20,19.5A1.5,1.5,0,0,1,18.5,18V14a1.5,1.5,0,0,1,3,0v4A1.5,1.5,0,0,1,20,19.5Z"
              fill="#aaadbf"
            />
            <path
              ...
              fill="#aaadbf"
            />
            <rect fill="#cc6c4a" height="30" rx="4" width="24" x="28" y="22" />
            <path
            ...
            />
            <path
              d="M44,41.5H36a1.5,1.5,0,0,1,0-3h8a1.5,1.5,0,0,1,0,3Z"
              fill="#f1f3f4"
            />
          </svg>
        </ElIcon>
